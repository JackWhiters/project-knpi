...
<footer class="main-footer">
  <div class="container">
    ...
    <strong><?php $i = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM identitas LIMIT 1"));  echo "$i[nama] "; ?> <i class="fa fa-copyright"></i> Copyright <?php echo date("Y");?>. Powered by <a target="_blank" href="https://smkgarudajakarta"><b>karpelpus.id</b></strong>
  </div>
  <!-- /.container -->
</footer>
