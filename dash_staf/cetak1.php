...
<body onload='window.print()' style="font-family: arial;font-size: 12px;">
        ...
        ?>
            ...
            <img style="position: absolute;margin-left: 40px;margin-top: 15px; width: 50px;" src="../assets/img/logo/<?php echo "$a[gambar] "?>">
            ...
            <p style="margin-left: 490px;font-family: arial;font-size: 10px;text-align: justify;padding-right: 25px;width: 35%;text-align: right;"><?php echo "$a[nama_kabupaten] "?>, <?php echo $tanggal ." ". $bulan ." ". $tahun;?></p>
            <p style="padding-left: 650px;font-family: arial;font-size: 10px;text-align: justify;padding-right: 25px;width: 35%;margin-top: -6px;">Mengetahui,<br><b>Kepala Sekolah<br><br><br><br><?php echo $blangko["kepsek"];?></b><br>NIP. <?php echo $blangko["nip"];?></p>
            <img style="padding-left: 580px;font-family: arial;font-size: 10px;text-align: justify;padding-right: 25px;width: 15%;margin-top: -65px;position: absolute;" src="../assets/img/tandatangan/<?php echo $blangko["ttd"];?>">
            <img style="border-radius: 2px;border:4px solid #fff;margin-left: 500px;font-family: arial;font-size: 10px;text-align: justify;width: 70px;margin-top: -80px;position: absolute;" src="../assets/img/qrcode/<?php echo $r["qrcode"];?>">
            </p>
        </div>
