...
<aside class="main-sidebar">
  ...
  <li class="treeview">
    <a href="tag-data">
      <i class="fa fa-print"></i> <span>CETAK Kartu 1</span>
  ...
  <li class="treeview">
    <a href="tag-data1">
      <i class="fa fa-print"></i> <span>CETAK Kartu 2</span>
      <span class="pull-right-container">
      </span>
    </a>
  </li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-red">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-warning"></i> UPS !!! AKSES MENU DITOLAK</h4>
      </div>
      <div class="modal-body">
        <center><img src="../assets/ionicons-2.0.1/src/android-hand.svg" width="30%">
